...
const remotesMap = {
'rom':{url:'http://localhost:4173/assets/remoteEntry.js',format:'esm',from:'vite'},
  'rom-project':{url:'http://localhost:4174/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const TimeSheet = react.exports.lazy(() => __federation_method_getRemote("rom" , "./TimeSheet").then(module=>__federation_method_wrapDefault(module, true)));
const Projects = react.exports.lazy(() => __federation_method_getRemote("rom-project" , "./Project").then(module=>__federation_method_wrapDefault(module, true)));
