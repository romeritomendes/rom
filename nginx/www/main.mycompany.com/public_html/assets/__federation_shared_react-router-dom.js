import { R as React, r as react } from './__federation_shared_react.js';
import { j as jsx, F as Fragment, a as jsxs } from './__federation_shared_react-icons.js';
...
class RenderErrorBoundary extends react.exports.Component {
  ...
  render() {
    ...
    /*#__PURE__*/
    /*#__PURE__*/
    jsx(RouteErrorContext.Provider, {
...
function useMatches() {
  ...
  return react.exports.useMemo(() => matches.map(match => {
    let {
      pathname,
      params
...
function RouterProvider(_ref) {
  ...
  return (
    /*#__PURE__*/
    /*#__PURE__*/
    jsx(DataRouterContext.Provider, {
      value: {
        router,
        navigator,
        static: false,
      ...
      children: /*#__PURE__*/jsx(DataRouterStateContext.Provider, {
        value: state,
        children: /*#__PURE__*/jsx(Router, {
          ...
          navigator: navigator,
          children: router.state.initialized ?
          /*#__PURE__*/
          /*#__PURE__*/
          jsx(Routes, {}) : fallbackElement
        })
      })
    })
  );
...
function Await(_ref6) {
  ...
  return (
    /*#__PURE__*/
    /*#__PURE__*/
    jsx(AwaitErrorBoundary, {
      resolve: resolve,
      errorElement: errorElement,
      children: /*#__PURE__*/jsx(ResolveAwait, {
        children: children
      })
    })
  );
...
function createFetcherForm(fetcherKey, routeId) {
  let FetcherForm = /*#__PURE__*/react.exports.forwardRef((props, ref) => {
    return (
      /*#__PURE__*/
      /*#__PURE__*/
      jsx(FormImpl, {
...
function useFetcher() {
  ...
  !(routeId != null) ? invariant(false) : void 0;
  let [fetcherKey] = react.exports.useState(() => String(++fetcherId));
  let [Form] = react.exports.useState(() => {
    !routeId ? invariant(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = react.exports.useState(() => href => {
    !router ? invariant(false) : void 0;
    !routeId ? invariant(false) : void 0;
    router.fetch(fetcherKey, routeId, href);
  });
  let submit = useSubmitImpl(fetcherKey, routeId);
  let fetcher = router.getFetcher(fetcherKey);
  let fetcherWithComponents = react.exports.useMemo(() => _extends({
    Form,
    submit,
    load
...
function useScrollRestoration(_temp3) {
  ...
  useBeforeUnload(react.exports.useCallback(() => {
...
export { AbortedDeferredError, Await, BrowserRouter, Form, HashRouter, Link, MemoryRouter, NavLink, Navigate, Action as NavigationType, Outlet, Route, Router, RouterProvider, Routes, ScrollRestoration, DataRouterContext as UNSAFE_DataRouterContext, DataRouterStateContext as UNSAFE_DataRouterStateContext, DataStaticRouterContext as UNSAFE_DataStaticRouterContext, LocationContext as UNSAFE_LocationContext, NavigationContext as UNSAFE_NavigationContext, RouteContext as UNSAFE_RouteContext, enhanceManualRouteObjects as UNSAFE_enhanceManualRouteObjects, createBrowserRouter, createHashRouter, createMemoryRouter, createPath, createRoutesFromChildren, createRoutesFromChildren as createRoutesFromElements, createSearchParams, defer, generatePath, isRouteErrorResponse, json, matchPath, matchRoutes, parsePath, redirect, renderMatches, resolvePath, HistoryRouter as unstable_HistoryRouter, useActionData, useAsyncError, useAsyncValue, useFetcher, useFetchers, useFormAction, useHref, useInRouterContext, useLinkClickHandler, useLoaderData, useLocation, useMatch, useMatches, useNavigate, useNavigation, useNavigationType, useOutlet, useOutletContext, useParams, useResolvedPath, useRevalidator, useRouteError, useRouteLoaderData, useRoutes, useSearchParams, useSubmit };
