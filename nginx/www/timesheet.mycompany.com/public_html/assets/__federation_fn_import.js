...
const moduleMap= {'axios':{get:()=>()=>__federation_import('./__federation_shared_axios.js'),import:true},'moment':{get:()=>()=>__federation_import('./__federation_shared_moment.js'),import:true},'react':{get:()=>()=>__federation_import('./__federation_shared_react.js'),import:true,requiredVersion:'^18.2.0'},'react-dom':{get:()=>()=>__federation_import('./__federation_shared_react-dom.js'),import:false,requiredVersion:'^18.2.0'},'styled-components':{get:()=>()=>__federation_import('./__federation_shared_styled-components.js'),import:true}};
